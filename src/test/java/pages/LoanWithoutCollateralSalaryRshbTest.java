...
public class LoanWithoutCollateralSalaryRshbTest extends BaseTest {
     ...
     */
    public LoanWithoutCollateralSalaryRshbTest creditCalculation() {
     ...
     * ввод суммы кредита
     */
    public LoanWithoutCollateralSalaryRshbTest creditSumSet() {
     ...
     * ввод срока кредита
     */
    public LoanWithoutCollateralSalaryRshbTest creditPeriodSet() {
        Actions actions = new Actions(driver);
     ...
     * выбор чекбоксов
     */
    public LoanWithoutCollateralSalaryRshbTest choiceCheckboxes() {
     ...
     */
    public LoanWithoutCollateralSalaryRshbTest valuesCheck() {
